...
<div class="container overlap" style = "text-align: center;">
	...
	<form id = "frm" action="${cpath }/board/write/">
		...
		<table class="table">
			<tbody>
	 			<tr>
	   				<td style = "width:15%; font-size: 13px">제목</td>
	   				<td style = "width:40%">
	   					<input type="text" class="form-control form-control-sm" id = "title" name = "title">
	   				</td>
	   				<td style = "width:15%; font-size: 13px">작성자</td>
	   				<td	style = "width:30%">
	 			...
	 			<tr>
	 				<td style = "font-size: 13px">비밀글 설정</td>
	      			<td style = "text-align: left">
	      				...
	      				style = "margin-top:7px;" onclick="check(1)">비공개글</label>
	      			</td>
	   				<td style = "font-size: 13px">비밀번호</td>
	      			<td>
